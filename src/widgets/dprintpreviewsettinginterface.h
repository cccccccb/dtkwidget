...
public:
    ...
    virtual bool settingFilter(const QVariant &mimeData, DPrintPreviewSettingInfo * const info) = 0;
    virtual SettingStatus settingStatus(const QVariant &mimeData, SettingSubControl control) = 0;
};
